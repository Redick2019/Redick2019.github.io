...
const tracks = [
  {
    ...
    emoji: "⚗️",
    title: "Life Labs",
    desc: "Real problems, solved with AI. From immigration tools to everyday utilities — proof that technology should work for people, not the other way around.",
    color: "#f5a623",
  ...
  },
  {
    ...
    emoji: "🔬",
    title: "DFIR Work",
    desc: "Digital Forensics & Incident Response — AI-assisted log investigation, packet analysis, memory forensics, and case studies demonstrating real investigative methodology.",
    color: "#00b4ff",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {tracks.map((t, i) => (
            <motion.div
              ...
              style={{
                background: `linear-gradient(140deg,${t.glow} 0%,#070e17 55%)`,
            ...
            >
              <div
                className="absolute w-44 h-44 rounded-full top-[-40px] right-[-40px] pointer-events-none"
