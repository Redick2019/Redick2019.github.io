...
export const events: Event[] = [
  ...
  },
  {
    ...
    date: "21–22 Aug 2026",
    tag: "Cybersecurity Conference",
    name: "BSides Bristol 2026",
    location: "Bristol Business School, UWE Frenchay Campus",
    about: "BSides Bristol's 2026 edition, held over two days at UWE Bristol's Frenchay Campus. A community-led, not-for-profit conference run entirely by volunteers, combining talks, hands-on workshops and villages across both offensive and defensive disciplines. The programme ranged from RF and aviation security through social engineering and physical intrusion to phishing analysis, honeypot detection and routes into offensive security — with an audience deliberately mixing students, career changers and long-standing practitioners.",
    reflection: "Spent two days at BSides Bristol. Always come away from these community-run security events with something new.\n\nA few themes stood out this time. The physical and RF side of security gets overlooked easily. Talks on ADS-B spoofing and creating phantom aircraft via Mode-S transponders were a good reminder that “cyber” extends past networks and endpoints into systems like aviation.\n\nThe human layer is still the easiest way in. “You've Been Ph0wned” and “Breaching The Perimeter” both made the same point from different directions: attackers rarely need a zero-day when a phone call or an unlocked door works just as well.\n\nDefenders are getting more creative too. Sessions on the evolution of phishing emails and honeypot detection via device wear-and-tear showed how much blue team thinking has moved on from just signature matching. And for anyone still figuring out where they fit in the industry, “So You Want To Get Into Red Teaming” was a refreshingly honest talk about the skills, mindset and myths around breaking into offensive security.\n\nWhat stood out most wasn't any single talk though. It was the room itself. Career changers, students and industry veterans mixing freely, the whole thing run by volunteers who clearly do it for the community rather than anything else.\n\nStill working toward my first full-time cyber security role, and days like this are a big part of why I keep at it. If you were there too, or you're active in the Bristol or Cheltenham security scene, I'd love to connect.",
    photos: []
  },
]
